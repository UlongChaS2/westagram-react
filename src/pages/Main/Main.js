        ...
        <nav>
          <div className='mainWrap'>
            ...
            <div className='searchBox'>
              <img alt='searchIcon' src='/image/serach.png' />
              <input className='searchText' type='text' placeholder='검색' />
            </div>
            <ul className='icons'>
              <li className='icon'>
                <img alt='main' src='/image/home_black.png' />
              </li>
              <li className='icon'>
                <img alt='DM' src='image/send.png' />
              </li>
              <li className='icon'>
                <img alt='explore' src='/image/compass.png' />
              </li>
              <li className='icon'>
                <img alt='likes' src='/image/heart.png' />
              </li>
              <li className='myAccount'>
                <img alt='myproflie' src='/image/mingky.jpg' />
              </li>
            </ul>
          </div>
        </nav>
            ...
            <div className='mainContents'>
              ...
              <article className='borderBox'>
                ...
                <div className='postComments'>
                  <div className='postSetting'>
                    <ul className='icons'>
                      ...
                      <li className='icon'>
                        <img alt='comments' src='/image/chat.png' />
                      </li>
                      <li className='icon'>
                        <img alt='share' src='/image/send.png' />
                      </li>
                    </ul>
                    <div className='postPhotoDots'></div>
                    <div className='icon bookmark'>
                      <img src='/image/bookmark_white.png' alt='bookmark' />
                    </div>
                  </div>
                ...
                <div className='newCommentBox'>
                  <div className='emoji'>
                    <img alt='emojiBox' src='/image/smile.png' />
                  </div>
                  <textarea
